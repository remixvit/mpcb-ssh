const ICONS = {
  ...
  serial: <><rect x="2" y="7" width="20" height="10" rx="2"/><path d="M6 11h.01M10 11h.01M14 11h.01M18 11h.01M6 13h8"/></>,
  bluetooth: <><path d="M6.5 6.5l11 11L12 23V1l5.5 5.5-11 11"/></>,
  iot: <><path d="M5 12.55a11 11 0 0 1 14.08 0"/><path d="M1.42 9a16 16 0 0 1 21.16 0"/><path d="M8.53 16.11a6 6 0 0 1 6.95 0"/><circle cx="12" cy="20" r="1" fill="currentColor"/></>,
